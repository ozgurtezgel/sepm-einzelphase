...
export class OwnerService {
  ...
  /**
   * Get owners according to speicfied name
   *
   * @param name the name of the owner that should be fetched
   * @param limitTo max number of owners that should be fetched
   */
