...
public interface OwnerService {
   ...
   * @throws ValidationException if the create data given for the owner is in itself incorrect (no first name, no last name)
   * @throws ConflictException if the create data given for the owner is causing conflicts with the current data in the system
   */
